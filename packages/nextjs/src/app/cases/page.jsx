                ...
                <section className={styles.firstSection}>
                    ...
                    <div className={styles.firstSectionFooter}>
                        <div className={styles.content}>
                            <Markdown>
                                By partnering with PersonalInvest for your IT
                                recruitment needs, you gain access to our
                                continuous support and guidance, even after the
                                placement is made, ensuring long-term success
                                and *satisfaction for both the candidate* and
                                *your organization.*
                            </Markdown>
                        </div>
