    ...
    <main className={styles.pageCases}>
      ...
      <div className="container">
        <section className={styles.sectionRecruitmentSummary}>
          <header>
            <Markdown>{mok.RecruitmentSummarySection.title}</Markdown>
            <Markdown>{mok.RecruitmentSummarySection.subtitle}</Markdown>
          </header>

          <div className={styles.list}>
            {mok.RecruitmentSummarySection.items.map((item, idx) => (
          ...
          <div className={styles.companyOffered}>
            ...
            <div>{mok.RecruitmentSummarySection.companyOffered}</div>
          </div>
        </section>
      </div>
        ...
        <div className="container">
          <section>
            ...
            <div className={styles.content}>
              <Markdown>
                ##### Feel free to contact us, and we will find *and IT
