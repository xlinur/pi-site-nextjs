...
export default function ExecutiveSearchPage() {
  const mok = {
    HeroSection: {
      ...
      subtitle:
        'Use the full potential of outstanding talent acquisition with PersonalInvest to find TOP IT candidates for executive and rare positions. We provide benefits of our permanent or contract executive recruitment services.',
      actions: [],
    },
